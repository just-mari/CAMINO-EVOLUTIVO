...
const EVOLUTION_STAGES = [
  { name: "Célula", color: "from-sky-400 to-blue-500", audio: "/audio/level1.mp3" },
  { name: "Planta", color: "from-green-400 to-lime-500", audio: "/audio/level2.mp3" },
  { name: "Animal", color: "from-orange-400 to-rose-500", audio: "/audio/level3.mp3" },
  { name: "Humano", color: "from-purple-400 to-pink-500", audio: "/audio/level4.mp3" },
  { name: "Conciencia", color: "from-yellow-300 to-white", audio: "/audio/level5.mp3" },
];
...
export default function Journey() {
  ...
  useEffect(() => {
    ...
    const unlockSound = new Howl({ src: ["/audio/unlock.mp3"], volume: 0 });
    unlockSound.play();
